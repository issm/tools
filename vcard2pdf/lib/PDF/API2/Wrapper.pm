...
sub importpage {
  my $self = shift;
  my $pdf_source   = shift;  # PDF::API2::Wrapper オブジェクト
...
Sabae::Ext::PDF - Simplifies to create simple PDF files.


=head1 SYNOPSIS

  use Sabae::Ext::PDF;
  $pdf = Sabae::Ext::PDF->new;
  $pdf->page;
...
=item $pdf = Sabae::Ext::PDF->new( %options )
